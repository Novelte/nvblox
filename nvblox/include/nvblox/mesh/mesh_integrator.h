...
class MeshIntegrator {
 public:
  ...
  void colorMesh(const SemanticLayer& semantic_layer, MeshLayer* mesh_layer);
  void colorMesh(const SemanticLayer& semantic_layer,
                 const std::vector<Index3D>& block_indices,
                 MeshLayer* mesh_layer);                 
  ...
  void colorMeshGPU(const ColorLayer& color_layer,
                    const std::vector<Index3D>& block_indices,
                    MeshLayer* mesh_layer);
  void colorMeshGPU(const SemanticLayer& semantic_layer, MeshLayer* mesh_layer);
  void colorMeshGPU(const SemanticLayer& semantic_layer,
                    const std::vector<Index3D>& block_indices,
                    MeshLayer* mesh_layer);                    
  ...
  void colorMeshCPU(const ColorLayer& color_layer,
                    const std::vector<Index3D>& block_indices,
                    MeshLayer* mesh_layer);
  void colorMeshCPU(const SemanticLayer& semantic_layer, MeshLayer* mesh_layer);
  void colorMeshCPU(const SemanticLayer& semantic_layer,
                    const std::vector<Index3D>& block_indices,
                    MeshLayer* mesh_layer);                    
